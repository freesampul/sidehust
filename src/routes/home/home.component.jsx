  ...
  return (
    <>
      <div className="h-screen overflow-hidden relative">
        <div className="h-screen bg-gradient-to-b from-red-200 to-white absolute top-0 left-0 right-0"></div>
        <div className="flex flex-col items-center justify-center h-screen relative">
          <Outlet />
          <div className="max-w-lg px-4">
            <div className="max-w-sm mx-auto bg-white text-red-500 rounded-lg p-4 mb-4 text-center absolute top-0 left-0 right-0 z-10 mt-20">
      ...
      <div className="h-screen overflow-hidden relative">
        <div className="h-screen bg-red-100 absolute bottom-0 left-0 right-0"></div>
      </div>
    </>
  );
};
