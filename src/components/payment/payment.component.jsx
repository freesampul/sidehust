        ...
        try {
            switch (selectedTier) {
                case "Free":
                    break;
                case "Entrepreneur":
                    priceId = "price_1Ov5k6DT4vO9oNMHPNCmYx59";
                    break; 
                case "Pro":
                    priceId = "price_1Ov5kRDT4vO9oNMHk8NsB1Y3";
                    break; 
                default:
                    break;
            }
        ...
        <div className="h-screen bg-gradient-to-b from-red-50 to-white-100">
            ...
            <div className="flex flex-col items-center justify-center h-full">
                <div className="hidden lg:block max-w-lg px-4">
                    <h1 className="text-3xl md:text-6xl font-bold text-center mb-4 md:mt-[10]">Let's get started!</h1>
                    <p className="text-sm md:text-lg text-center mb-4">Learn today for completely free</p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-3 mx-auto w-full md:w-4/5 p-4">
                    ...
                    <div className="bg-red-500 text-white rounded-lg shadow-lg p-4">
                        <h2 className="text-xl font-bold mb-2">Entrepreneur</h2>
                        ...
                        <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded w-full" onClick={() => handlePayment("Entrepreneur")}>Upgrade</button>
                    </div>
                    <div className="bg-gray-200 rounded-lg shadow-lg p-4">
